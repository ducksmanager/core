      ...
      <div class="showcase">
        ...
        <b-row>
          <b-col offset-md="1" lg="5">
            <img :src="`${imagePath}/demos/montage_small.jpg`" alt="logo" />
          </b-col>
          <b-col lg="5">
            <div>
              {{
        ...
        <b-row>
          ...
          <b-col lg="5">
            <img :src="`${imagePath}/demos/manage.jpg`" alt="demo_gerer" />
          </b-col>
        </b-row>
        <hr />
        <b-row>
          ...
          <b-col lg="5">
            <h3>
              {{ $t("Votre bibliothèque, comme si vous étiez devant !") }}
            </h3>
            <div>
              {{
                $t(
        ...
        <b-row>
          ...
          <b-col lg="5">
            <img
              :src="`${imagePath}/demos/author_stats.png`"
