...
CREATE INDEX index_issue USING HASH ON dm_stats.histoires_publications (publicationcode, issuenumber);
CREATE INDEX index_story USING HASH ON dm_stats.histoires_publications (storycode);
...
(
    ...
    CONSTRAINT utilisateurs_publications_suggerees_pseudos_fk FOREIGN KEY (ID_User) REFERENCES dm_stats.auteurs_pseudos_simple (ID_User)
);
