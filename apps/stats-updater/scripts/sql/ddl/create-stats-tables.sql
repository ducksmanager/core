...
CREATE INDEX pk ON dm_stats.auteurs_histoires (personcode, storycode);
...
CREATE INDEX PK ON dm_stats.utilisateurs_publications_manquantes (ID_User, storycode, publicationcode, issuenumber);
