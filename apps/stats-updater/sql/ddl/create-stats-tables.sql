CREATE TABLE IF NOT EXISTS auteurs_histoires
(
...
CREATE TABLE IF NOT EXISTS histoires_publications
(
    ID int auto_increment primary key,
    storycode VARCHAR(19) NOT NULL,
    publicationcode VARCHAR(12) NOT NULL,
    issuenumber VARCHAR(12) NOT NULL,
    issuecode VARCHAR(24) NOT NULL,
    oldestdate DATE,
...
CREATE TABLE IF NOT EXISTS utilisateurs_histoires_manquantes
(
    ID int auto_increment primary key,
...
CREATE TABLE IF NOT EXISTS utilisateurs_publications_manquantes
(
    ID int auto_increment primary key,
    ID_User INT(11) NOT NULL,
    personcode VARCHAR(22) NOT NULL,
...
CREATE TABLE IF NOT EXISTS utilisateurs_publications_suggerees
(
    ID int auto_increment primary key,
    ID_User INT(11) NOT NULL,
    publicationcode VARCHAR(12) NOT NULL,
