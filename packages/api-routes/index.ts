...
import { CoverSearchResults } from "~types/CoverSearchResults";
...
import {} from "~types/IssueSuggestionList";
...
export class GET__bookstores extends ContractWithMethodAndUrl<{
  resBody: SimpleBookstore[];
}> {
...
export class GET__csrf extends ContractWithMethodAndUrl<{
  resBody: { csrfToken: string };
}> {
  static readonly method = "get";
  static readonly url = "/csrf";
}
export class POST__demo extends ContractWithMethodAndUrl<{
  resBody: { token: string };
}> {
  static readonly method = "post";
  static readonly url = "/demo";
}
export class GET__events extends ContractWithMethodAndUrl<{
  resBody: Event[];
}> {
  static readonly method = "get";
...
export class GET__auth__forgot extends ContractWithMethodAndUrl<{
  query: { token: string };
}> {
  static readonly method = "get";
...
export class POST__bookstores__approve extends ContractWithMethodAndUrl<{
  reqBody: { id: number };
}> {
  static readonly method = "post";
  static readonly url = "/bookstores/approve";
}
export class POST__collection__empty extends ContractWithMethodAndUrl<
  Record<string, never>
> {
  static readonly method = "post";
  static readonly url = "/collection/empty";
}
export class GET__collection__issues extends ContractWithMethodAndUrl<{
  resBody: issue[];
}> {
  static readonly method = "get";
  static readonly url = "/collection/issues";
}
export class POST__collection__lastvisit extends ContractWithMethodAndUrl<{
  resBody: { previousVisit: Date | null };
}> {
  static readonly method = "post";
...
export class GET__collection__points extends ContractWithMethodAndUrl<{
  resBody: MedalPoints;
}> {
  static readonly method = "get";
  static readonly url = "/collection/points";
}
export class GET__collection__popular extends ContractWithMethodAndUrl<{
  resBody: SimplePopularity[];
}> {
  static readonly method = "get";
...
export class PUT__collection__subscriptions extends ContractWithMethodAndUrl<{
  reqBody: { subscription: EditSubscription };
}> {
  static readonly method = "put";
  static readonly url = "/collection/subscriptions";
}
export class GET__collection__user_privileges extends ContractWithMethodAndUrl<{
  resBody: userPermission[];
}> {
  static readonly method = "get";
  static readonly url = "/collection/user-privileges";
}
export class DELETE__collection__user extends ContractWithMethodAndUrl<
  Record<string, never>
> {
  static readonly method = "delete";
  static readonly url = "/collection/user";
}
export class GET__collection__user extends ContractWithMethodAndUrl<{
...
export class PUT__edgecreator__edgesprites extends ContractWithMethodAndUrl<
  Record<string, never>
> {
  static readonly method = "put";
  static readonly url = "/edgecreator/edgesprites";
}
export class GET__edgecreator__model extends ContractWithMethodAndUrl<{
  resBody: EdgeModel[];
}> {
  static readonly method = "get";
...
export class POST__notification__send extends ContractWithMethodAndUrl<
  Record<string, never>
> {
  static readonly method = "post";
  static readonly url = "/notification/send";
}
export class GET__status__db extends ContractWithMethodAndUrl<{
  resBody: { status: string };
}> {
  static readonly method = "get";
  static readonly url = "/status/db";
}
export class GET__status__pastec extends ContractWithMethodAndUrl<{
  resBody: { status: string | number };
}> {
  static readonly method = "get";
  static readonly url = "/status/pastec";
}
export class GET__status__pastecsearch extends ContractWithMethodAndUrl<{
  resBody: { status: string | number };
}> {
  static readonly method = "get";
...
export class DELETE__collection__authors__watched extends ContractWithMethodAndUrl<{
  reqBody: { personcode: string };
}> {
  static readonly method = "delete";
  static readonly url = "/collection/authors/watched";
}
export class GET__collection__authors__watched extends ContractWithMethodAndUrl<{
  resBody: authorUser[];
}> {
  static readonly method = "get";
  static readonly url = "/collection/authors/watched";
...
export class PUT__collection__authors__watched extends ContractWithMethodAndUrl<{
  reqBody: { personcode: string };
}> {
  static readonly method = "put";
  static readonly url = "/collection/authors/watched";
}
export class GET__collection__edges__lastPublished extends ContractWithMethodAndUrl<{
  resBody: edge[];
}> {
  static readonly method = "get";
...
export class DELETE__collection__on_sale_by_others__requests extends ContractWithMethodAndUrl<{
  reqBody: { issueId: number };
}> {
  static readonly method = "delete";
  static readonly url = "/collection/on-sale-by-others/requests";
}
export class PUT__collection__on_sale_by_others__requests extends ContractWithMethodAndUrl<{
  reqBody: { issueIds: number[] };
}> {
  static readonly method = "put";
  static readonly url = "/collection/on-sale-by-others/requests";
}
export class GET__collection__stats__watchedauthorsstorycount extends ContractWithMethodAndUrl<{
  resBody: AuthorsDetails;
}> {
  static readonly method = "get";
...
export class GET__edges__wanted__data extends ContractWithMethodAndUrl<{
  resBody: WantedEdge[];
}> {
  static readonly method = "get";
  static readonly url = "/edges/wanted/data";
}
export class GET__global_stats__bookcase__contributors extends ContractWithMethodAndUrl<{
  resBody: BookcaseContributor[];
}> {
  static readonly method = "get";
  static readonly url = "/global-stats/bookcase/contributors";
}
export class GET__global_stats__user__count extends ContractWithMethodAndUrl<{
  resBody: { count: number };
}> {
  static readonly method = "get";
  static readonly url = "/global-stats/user/count";
}
export class GET__global_stats__user__list extends ContractWithMethodAndUrl<{
  resBody: Pick<user, "id" | "username">[];
}> {
  static readonly method = "get";
...
export class GET__coa__list__issues__count extends ContractWithMethodAndUrl<{
  resBody: Record<string, number>;
}> {
  static readonly method = "get";
...
export class GET__coa__list__issues__recent extends ContractWithMethodAndUrl<{
  resBody: inducks_issue[];
}> {
  static readonly method = "get";
...
export class DELETE__collection__purchases__$id extends ContractWithMethodAndUrl<{
  params: { id: string };
}> {
  static readonly method = "delete";
  static readonly url = "/collection/purchases/:id";
}
export class DELETE__collection__subscriptions__$id extends ContractWithMethodAndUrl<{
  params: { id: string };
}> {
  static readonly method = "delete";
...
export class GET__cover_id__download__$coverId extends ContractWithMethodAndUrl<{
...
export class GET__edgecreator__model__editedbyother__all extends ContractWithMethodAndUrl<{
  resBody: EdgeModel[];
}> {
  static readonly method = "get";
  static readonly url = "/edgecreator/model/editedbyother/all";
}
export class GET__edgecreator__model__unassigned__all extends ContractWithMethodAndUrl<{
  resBody: EdgeModel[];
}> {
  static readonly method = "get";
...
export class GET__collection__on_sale_by_others__contact_methods__$sellerId extends ContractWithMethodAndUrl<{
  ...
  static readonly method = "get";
  static readonly url =
    "/collection/on-sale-by-others/contact-methods/:sellerId";
}
...
export class GET__edgecreator__model__$countrycode__$magazinecode__$issuenumber extends ContractWithMethodAndUrl<{
  ...
  static readonly method = "get";
  static readonly url =
    "/edgecreator/model/:countrycode/:magazinecode/:issuenumber";
}
...
export class GET__collection__stats__suggestedissues__$countrycode__$sincePreviousVisit__$sort__$limit extends ContractWithMethodAndUrl<{
  ...
  static readonly method = "get";
  static readonly url =
    "/collection/stats/suggestedissues/:countrycode/:sincePreviousVisit/:sort/:limit";
}
