...
create index fk0 on inducks_appearance (charactercode);
create index fk1 on inducks_appearance (appearancecomment);
create index pk0 on inducks_appearance (storyversioncode, charactercode);
...
create fulltext index fulltext_inducks_character on inducks_character (charactername);
create index pk0 on inducks_character (charactercode);
create table inducks_characteralias (
    charactercode varchar(31) null,
    charactername varchar(58) null
);
create index fk0 on inducks_characteralias (charactercode);
create index pk0 on inducks_characteralias (charactername);
create table inducks_characterdetail (
    charactername varchar(7) null,
    charactercode varchar(6) null,
    number int(7) null
);
create index fk0 on inducks_characterdetail (charactername);
create index pk0 on inducks_characterdetail (charactercode);
...
create index fk0 on inducks_charactername (languagecode);
create index pk0 on inducks_charactername (charactercode, languagecode, charactername);
...
create index fk0 on inducks_characterreference (tocharactercode);
create index pk0 on inducks_characterreference (fromcharactercode, tocharactercode);
create table inducks_characterurl (
    charactercode varchar(1) null,
    sitecode varchar(1) null,
    url varchar(1) null
);
create index fk0 on inducks_characterurl (sitecode);
create index pk0 on inducks_characterurl (charactercode, sitecode);
...
create index pk0 on inducks_country (countrycode);
create table inducks_countryname (
    countrycode varchar(2) null,
    languagecode varchar(5) null,
    countryname varchar(56) null
);
create index fk0 on inducks_countryname (languagecode);
create index pk0 on inducks_countryname (countrycode, languagecode);
create table inducks_currency (
    currencycode varchar(3) null,
    currencyname varchar(18) null
);
create index pk0 on inducks_currency (currencycode);
...
create index fk0 on inducks_currencyname (languagecode);
create index pk0 on inducks_currencyname (currencycode, languagecode);
...
create fulltext index entryTitleFullText on inducks_entry (title);
create index fk0 on inducks_entry (issuecode);
create index fk1 on inducks_entry (storyversioncode);
create index fk2 on inducks_entry (languagecode);
create index fk3 on inducks_entry (includedinentrycode);
create index fk4 on inducks_entry (position);
create index pk0 on inducks_entry (entrycode);
...
create index fk0 on inducks_entrycharactername (charactercode);
create index pk0 on inducks_entrycharactername (entrycode, charactercode);
...
create index fk0 on inducks_entryjob (personcode);
create index pk0 on inducks_entryjob (entrycode, personcode, transletcol);
...
create index fk0 on inducks_entryurl (entrycode);
create index fk1 on inducks_entryurl (sitecode);
create index fk2 on inducks_entryurl (url);
create index fk3 on inducks_entryurl (storycode);
create index inducks_entryurl_sitecode_url_index on inducks_entryurl (sitecode, url);
create table inducks_entryurl_vector (
    ID int auto_increment primary key,
    entrycode varchar(21) not null,
...
create index fk0 on inducks_equiv (equivid);
create index pk0 on inducks_equiv (issuecode, equivid);
...
create index fk0 on inducks_herocharacter (charactercode);
create index pk0 on inducks_herocharacter (storycode, charactercode);
...
create index pk0 on inducks_inputfile (inputfilecode);
...
create index fk0 on inducks_issue (issuerangecode);
create index fk1 on inducks_issue (publicationcode);
create index inducks_issue_publicationcode_index on inducks_issue (publicationcode);
create index inducks_issue_short_issuecode_index on inducks_issue (short_issuecode);
create index pk0 on inducks_issue (issuecode);
create table inducks_issue2 (
    issuecode varchar(19) not null primary key,
    issuerangecode varchar(15) null,
    publicationcode varchar(12) null,
    issuenumber varchar(13) null,
    title varchar(158) null,
...
create index fk0 on inducks_issue2 (issuerangecode);
create index fk1 on inducks_issue2 (publicationcode);
create table inducks_issuecollecting (
    collectingissuecode varchar(17) null,
    collectedissuecode varchar(15) null
);
create index fk0 on inducks_issuecollecting (collectedissuecode);
create index pk0 on inducks_issuecollecting (collectingissuecode, collectedissuecode);
...
create index pk0 on inducks_issuedate (issuecode, date);
...
create index fk0 on inducks_issuejob (personcode);
create index pk0 on inducks_issuejob (issuecode, personcode, inxtransletcol);
...
create index pk0 on inducks_issueprice (issuecode, amount);
create table inducks_issuequotation_raw (
    ID int auto_increment primary key,
...
create index inducks_issuequotation_raw__index_publication on inducks_issuequotation_raw (publicationcode);
create index inducks_issuequotation_raw__uindex_issuecode_source on inducks_issuequotation_raw (issuecode, source);
...
create index fk0 on inducks_issuerange (publicationcode);
create index pk0 on inducks_issuerange (issuerangecode);
...
create index fk0 on inducks_issueurl (sitecode);
create index pk0 on inducks_issueurl (issuecode, sitecode);
create table inducks_language (
    languagecode varchar(7) null,
    defaultlanguagecode varchar(5) null,
    languagename varchar(20) null
);
create index fk0 on inducks_language (defaultlanguagecode);
create index pk0 on inducks_language (languagecode);
create table inducks_languagename (
    desclanguagecode varchar(5) null,
    languagecode varchar(7) null,
    languagename varchar(57) null
);
create index fk0 on inducks_languagename (languagecode);
create index pk0 on inducks_languagename (desclanguagecode, languagecode);
...
create index pk0 on inducks_log (number);
create table inducks_logdata (
    logid varchar(4) null,
    category int(7) null,
    logtext varchar(108) null
);
create index pk0 on inducks_logdata (logid);
...
create index fk0 on inducks_logocharacter (charactercode);
create index pk0 on inducks_logocharacter (entrycode, charactercode);
...
create fulltext index fulltext_inducks_movie on inducks_movie (
    title,
    moviecomment,
    appsummary,
    moviejobsummary,
...
create index pk0 on inducks_movie (moviecode);
create table inducks_moviecharacter (
    moviecode varchar(14) null,
    charactercode varchar(38) null,
    istitlecharacter enum ('Y', 'N') null
);
create index fk0 on inducks_moviecharacter (charactercode);
create index pk0 on inducks_moviecharacter (moviecode, charactercode);
...
create index fk0 on inducks_moviejob (personcode);
create index pk0 on inducks_moviejob (moviecode, personcode, role);
...
create index fk0 on inducks_moviereference (moviecode);
create index fk1 on inducks_moviereference (referencereasonid);
create index pk0 on inducks_moviereference (storycode, moviecode);
...
create index fk0 on inducks_person (nationalitycountrycode);
create fulltext index fulltext_inducks_person on inducks_person (fullname, birthname);
create index pk0 on inducks_person (personcode);
...
create index fk0 on inducks_personalias (personcode);
create table inducks_personurl (
    personcode varchar(24) null,
    sitecode varchar(15) null,
    url varchar(31) null
);
create index fk0 on inducks_personurl (sitecode);
create index pk0 on inducks_personurl (personcode, sitecode);
...
create index fk0 on inducks_publication (countrycode);
create index fk1 on inducks_publication (languagecode);
create fulltext index fulltext_inducks_publication on inducks_publication (title);
create index pk0 on inducks_publication (publicationcode);
create table inducks_publicationcategory (
    publicationcode varchar(12) null,
    category varchar(61) null
);
create index pk0 on inducks_publicationcategory (publicationcode);
create table inducks_publicationname (
    publicationcode varchar(9) null,
    publicationname varchar(62) null
);
create index pk0 on inducks_publicationname (publicationcode);
create table inducks_publicationurl (
    publicationcode varchar(10) null,
    sitecode varchar(16) null,
    url varchar(236) null
);
create index fk0 on inducks_publicationurl (sitecode);
create index pk0 on inducks_publicationurl (publicationcode, sitecode);
create table inducks_publisher (
    publisherid varchar(94) null,
    publishername text null
);
create fulltext index fulltext_inducks_publisher on inducks_publisher (publishername);
create index pk0 on inducks_publisher (publisherid);
...
create index fk0 on inducks_publishingjob (issuecode);
create index pk0 on inducks_publishingjob (publisherid, issuecode);
create table inducks_referencereason (
    referencereasonid int(7) null,
    referencereasontext varchar(129) null
);
create index pk0 on inducks_referencereason (referencereasonid);
create table inducks_referencereasonname (
    referencereasonid int(7) null,
    languagecode varchar(2) null,
    referencereasontranslation varchar(28) null
);
create index fk0 on inducks_referencereasonname (languagecode);
create index pk0 on inducks_referencereasonname (referencereasonid, languagecode);
...
create index pk0 on inducks_site (sitecode);
...
create index pk0 on inducks_statcharactercharacter (charactercode, total);
create table inducks_statcharactercountry (
    charactercode varchar(58) null,
    countrycode varchar(2) null,
    total int(7) null
);
create index pk0 on inducks_statcharactercountry (charactercode, countrycode);
...
create index pk0 on inducks_statcharacterstory (charactercode, storyheadercode);
...
create index pk0 on inducks_statpersoncharacter (personcode, total);
create table inducks_statpersoncountry (
    personcode varchar(79) null,
    countrycode varchar(2) null,
    total int(7) null
);
create index pk0 on inducks_statpersoncountry (personcode, countrycode);
...
create index pk0 on inducks_statpersonperson (personcode, total);
...
create index pk0 on inducks_statpersonstory (personcode, storyheadercode);
create table inducks_story (
    ...
    usedifferentcode text null,
    storycomment varchar(903) null,
    error enum ('Y', 'N') null,
    repcountrysummary varchar(106) null,
...
create index fk0 on inducks_story (originalstoryversioncode);
create index fk1 on inducks_story (endpublicationdate);
create fulltext index fulltext_inducks_story_storycode on inducks_story (storycode);
create index pk0 on inducks_story (storycode);
...
create index fk0 on inducks_storycodes (alternativecode);
create index pk0 on inducks_storycodes (storycode, alternativecode);
create table inducks_storycreationdate (
    storycode varchar(17) null,
    creationdate varchar(10) null,
    creationcomment varchar(26) null
);
create index pk0 on inducks_storycreationdate (storycode, creationdate);
create table inducks_storydescription (
    storyversioncode varchar(19) null,
    languagecode varchar(7) null,
    desctext varchar(2814) null
);
create index fk0 on inducks_storydescription (languagecode);
create index pk0 on inducks_storydescription (storyversioncode, languagecode);
...
create index pk0 on inducks_storyheader (storyheadercode, level);
...
create index fk0 on inducks_storyjob (personcode);
create index pk0 on inducks_storyjob (storyversioncode, personcode, plotwritartink);
create table inducks_storyreference (
    fromstorycode varchar(18) null,
    tostorycode varchar(17) null,
    referencereasonid int(7) null
);
create index fk0 on inducks_storyreference (tostorycode);
create index fk1 on inducks_storyreference (referencereasonid);
create index pk0 on inducks_storyreference (fromstorycode, tostorycode);
create table inducks_storysubseries (
    storycode varchar(18) null,
    subseriescode varchar(144) null,
    storysubseriescomment varchar(33) null
);
create index fk0 on inducks_storysubseries (subseriescode);
create index pk0 on inducks_storysubseries (storycode, subseriescode);
create table inducks_storyurl (
    storycode varchar(13) null,
    sitecode varchar(15) null,
    url varchar(43) null
);
create index fk0 on inducks_storyurl (sitecode);
create index pk0 on inducks_storyurl (storycode, sitecode);
...
create index fk1 on inducks_storyversion (storycode);
create fulltext index fulltext_inducks_storyversion on inducks_storyversion (
    appsummary,
    plotsummary,
    writsummary,
    artsummary,
...
create index pk0 on inducks_storyversion (storyversioncode);
...
create index fk0 on inducks_studio (countrycode);
create index pk0 on inducks_studio (studiocode);
create table inducks_studiowork (
    studiocode varchar(23) null,
    personcode varchar(24) null
);
create index fk0 on inducks_studiowork (personcode);
create index pk0 on inducks_studiowork (studiocode, personcode);
...
create index pk0 on inducks_subseries (subseriescode);
...
create index fk0 on inducks_subseriesname (languagecode);
create index pk0 on inducks_subseriesname (subseriescode, languagecode);
...
create index fk0 on inducks_substory (firstpublicationdate);
create index pk0 on inducks_substory (storycode);
create table inducks_team (
    teamcode varchar(13) null,
    teamdescriptionname varchar(25) null,
    teamshortname varchar(7) null
);
create index pk0 on inducks_team (teamcode);
create table inducks_teammember (
    teamcode varchar(13) null,
    personcode varchar(3) null
);
create index pk0 on inducks_teammember (teamcode);
create table inducks_ucrelation (
    universecode varchar(28) null,
    charactercode varchar(45) null
);
create index fk0 on inducks_ucrelation (charactercode);
create index pk0 on inducks_ucrelation (universecode, charactercode);
create table inducks_universe (
    universecode varchar(28) null,
    universecomment varchar(1) null
);
create index pk0 on inducks_universe (universecode);
create table inducks_universename (
    universecode varchar(28) null,
    languagecode varchar(5) null,
    universename varchar(76) null
);
create index fk0 on inducks_universename (languagecode);
create index pk0 on inducks_universename (universecode, languagecode);
create table induckspriv_entry (
    entrycode varchar(37) null,
    entrycomment varchar(1936) null
);
create index pk0 on induckspriv_entry (entrycode);
...
create index pk0 on induckspriv_issue (issuecode);
        ...
        (
            (
                (
                    (
                        (
                            `coa`.`duckguessr_published_fr_recent_game_all` `entryurl_ids`
                            join `coa`.`inducks_entryurl` `entryurl` on (`entryurl_ids`.`entryurl_id` = `entryurl`.`id`)
                        )
                        join `coa`.`inducks_entry` `entry` on (`entryurl`.`entrycode` = `entry`.`entrycode`)
                    )
                    join `coa`.`inducks_storyversion` `storyversion` on (
                        `entry`.`storyversioncode` = `storyversion`.`storyversioncode`
                    )
                )
                join `coa`.`inducks_story` `story` on (`storyversion`.`storycode` = `story`.`storycode`)
            )
            join `coa`.`inducks_storyjob` `storyjob` on (
                `entry`.`storyversioncode` = `storyjob`.`storyversioncode`
            )
        )
        join (
            select `artist_with_2000s_entries`.`personcode` AS `personcode`,
                `person`.`nationalitycountrycode` AS `nationalitycountrycode`,
                `person`.`fullname` AS `fullname`
            from (
                    `coa`.`duckguessr_published_fr_recent_game_all` `artist_with_2000s_entries`
                    join `coa`.`inducks_person` `person` on (
                        `artist_with_2000s_entries`.`personcode` = `person`.`personcode`
                    )
                )
            group by `artist_with_2000s_entries`.`personcode`
            having count(0) >= 20
        ) `artist_with_at_least_20_entries` on (
...
select `coa`.`inducks_issue`.`issuecode` AS `issuecode`,
    ...
    `coa`.`inducks_issue`.`publicationcode` AS `publicationcode`,
    `coa`.`inducks_issue`.`issuenumber` AS `issuenumber`,
    `coa`.`inducks_issue`.`title` AS `title`,
    `coa`.`inducks_issue`.`size` AS `size`,
    `coa`.`inducks_issue`.`pages` AS `pages`,
    `coa`.`inducks_issue`.`price` AS `price`,
    `coa`.`inducks_issue`.`printrun` AS `printrun`,
    `coa`.`inducks_issue`.`attached` AS `attached`,
    `coa`.`inducks_issue`.`oldestdate` AS `oldestdate`,
    `coa`.`inducks_issue`.`fullyindexed` AS `fullyindexed`,
    `coa`.`inducks_issue`.`issuecomment` AS `issuecomment`,
    `coa`.`inducks_issue`.`error` AS `error`,
    `coa`.`inducks_issue`.`filledoldestdate` AS `filledoldestdate`,
    `coa`.`inducks_issue`.`locked` AS `locked`,
    `coa`.`inducks_issue`.`inxforbidden` AS `inxforbidden`,
    `coa`.`inducks_issue`.`inputfilecode` AS `inputfilecode`,
    `coa`.`inducks_issue`.`maintenanceteamcode` AS `maintenanceteamcode`,
    `coa`.`inducks_issue`.`short_issuecode` AS `short_issuecode`
from `coa`.`inducks_issue`
order by `coa`.`inducks_issue`.`publicationcode`,
    `coa`.`inducks_issue`.`issuenumber`;
create definer = root @`%` view inducks_issuequotation as
select `q`.`ID` AS `ID`,
    `q`.`publicationcode` AS `publicationcode`,
    `q`.`issuenumber` AS `issuenumber`,
    (
        select avg(`q2`.`estimationmin`)
        from `coa`.`inducks_issuequotation_raw` `q2`
        where `q`.`issuecode` = `q2`.`issuecode`
            and `q2`.`estimationmin` is not null
    ) AS `estimationmin`,
    (
        select avg(`q2`.`estimationmax`)
        from `coa`.`inducks_issuequotation_raw` `q2`
        where `q`.`issuecode` = `q2`.`issuecode`
            and `q2`.`estimationmax` is not null
    ) AS `estimationmax`,
    `q`.`issuecode` AS `issuecode`
from `coa`.`inducks_issuequotation_raw` `q`
