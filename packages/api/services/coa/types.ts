...
export default abstract class {
  ...
  abstract getRecentIssues: (callback: (value: inducks_issue[]) => void) => void;
  ...
  abstract   searchStory: (keywords: string[], withIssues: boolean, callback: (value: StorySearchResults) => void) => void;
