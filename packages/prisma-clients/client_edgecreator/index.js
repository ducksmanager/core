...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "dist/prisma/client_edgecreator",
    "prisma/client_edgecreator",
  ]
...
path.join(process.cwd(), "dist/prisma/client_edgecreator/libquery_engine-debian-openssl-1.1.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "dist/prisma/client_edgecreator/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "dist/prisma/client_edgecreator/schema.prisma")
