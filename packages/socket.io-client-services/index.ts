...
type AllButLast<T extends unknown[]> = T extends [...infer H, infer _L] ? H : unknown[];
  ...
  >(
    ...
    return {
      ...
      on: <E extends StringKeyOf<ServerSentEvents>>(
        ...
        socket?.on(
          event,
          callback as FallbackToUntypedListener<E extends "connect" | "connect_error" | "disconnect" ? SocketReservedEvents[E] : E extends string ? (...args: unknown[]) => void : never>,
        );
      },
